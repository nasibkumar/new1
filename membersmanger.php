...
<html lang="en">
  ...
  <div class="bg-modal" align=center>
<div class="modal-content">
<div class="close">x</div>
<div>
<form>
<br><br><br><br>
<b><label style="margin-left:20px;">EID</label></b>
...
<ul class="ul1">
<button id="id1" style="font-size:25px; margin-left:70px;"><a href="add.php">ADD</a></button>
<button id="id2" style="font-size:25px; margin-left:30px;">DELETE</button>
<button id="id3" style="font-size:25px; margin-left:30px;"><a href="">UPDATE</a></button>
</li>
</ul>
